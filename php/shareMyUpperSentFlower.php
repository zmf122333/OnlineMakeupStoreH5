...
$redbagUp = Config::_getMyRedbagUp($uid);
    ...
    <li class="aui-list-item" id="MyAllOrder">
        ...
        <div class="aui-list-item-inner aui-list-item-arrow">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-right">￥<?php echo $redbagUp?></div>
            </div>
    </li>
</ul>
<ul class="aui-list aui-list-in">
    <li class="aui-list-item" id="MyAllOrder">
        <div class="aui-list-item-label-icon">
            <img src="../image/flower.png" style="width: 32px;height: 32px">
        </div>
        <div class="aui-list-item-inner aui-list-item-arrow">
            <div class="aui-list-item-inner">
...
<!--    <div class="aui-col-xs-2"><img src="../image/redbag.png" style="width: 32px;height: 32px"></div>-->
<!--    <div class="aui-col-xs-8">收到的红包(余额)</div>-->
<!--    <div class="aui-col-xs-2">￥--><?php //echo $redbagUp?><!--</div>-->
<!--</div>-->
<!--<div class="aui-col-xs-12 aui-padded-15">-->
<!--    <div class="aui-col-xs-2"><img src="../image/flower.png" style="width: 32px;height: 32px"></div>-->
<!--    <div class="aui-col-xs-8">收到的小红花(余额)</div>-->
<!--    <div class="aui-col-xs-2">--><?php //echo $flowerUp?><!--朵</div>-->
<!--</div>-->

<li class="aui-list-item" style="color:lightgrey;padding: 10px;border: none">
    友情提示：<br>1.收到的红包您可以手动转入您的美丽分享余额，您可以随时提现哦~<br>2.每朵花价值1元，这些小红花来自您的美丽分享官的慷慨赠送，您本人购买商品时可用于抵扣
</li>
